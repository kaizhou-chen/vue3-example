import{Q as i}from"./QuestionLayout-C6hZXuDt.js";import r from"./KeyPoint-BIJP3E-W.js";import{v as n}from"./VCodeHighlight-Dt-0rB3p.js";import{d as c,r as p,o as a,b as d,w as m,H as u,I as l,X as t,Y as _,u as o,e as f,C as h,D as x}from"./index-D-j_Yy59.js";import{_ as g}from"./plugin-vueexport-helper-DlAUqK2U.js";import"./main-DKUsQMnN.js";const v=e=>(h("data-v-840af99f"),e=e(),x(),e),w=v(()=>t("p",null,"完成 arrange 函数，执行结果如下",-1)),C={class:"question"},y={class:"javascript"},D="",I=c({__name:"ChainAndDelay",setup(e){const s=p(`arrange('William')
  .wait(5)
	.do('commit')
	.waitFirst(3)
	.execute();
